...
import {DummyBg, IcBackWhite} from '../../assets';
import {Rating,Counter,Number} from '../../components';
...
const FoodDetail = ({navigation, route}) => {
  ...
  useEffect(() => {
    getData('userProfile').then(res => {
      console.log('Data User Profile Food Detail : ', res);
      setUserProfile(res);
    })
  }, [])
      ...
      <View style={styles.content}>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.button}>
            <Button title="Order Now" onPress={onOrder} color='#FFC700' />
          </View>
        </View>
      </View>
      </View>
